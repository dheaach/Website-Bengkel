...
class TransaksiModel extends CI_Model {
  ...
  public function view_all(){
    return $this->db->query("SELECT * FROM penjualan WHERE jenis='langsung' ")->result(); // Tampilkan semua data transaksi
  }
    ...
    $query = $this->db->query("SELECT * FROM penjualan WHERE jenis='langsung' AND staff LIKE '%$keyword%'OR tanggal LIKE '%$keyword%'");
    return $query->result(); 
    }
