...
<div class="row">
    <div class="col-md-12">
    <form action="<?php echo base_url('penjualan/nyimpen') ?>" method="POST">
                            ...
                            <div class="rows" style="color:black">
                                <div class="wcol-6">
                                    <div class="wform-group">
                                        ...
                                        <input class="winput winput-md" type="text" name="kode_penjualan" id="kode_penjualan" placeholder="No. Nota" autocomplete="off" required/>
                                    </div>  
                                    <div class="wform-group">
                                        ...
                                        <tr>
                                            ...
                                            <select class="winput winput-lg" name="id_customer" id="id_customer" required>
                                                ...
                                                <?php
                                                    $sup = $this->db->query('SELECT * FROM customer'); 
                                            ...
                                            <td width="50%">
                                                <input class="winput winput-lg" type="text" name="name" id="name" placeholder="Nama Customer" readonly required> 
                                            </td>
                                        </tr>
                                        </table>
                                    </div>   
                                ...
                                <div class="wcol-6">
                                    <div class="wform-group">
                                        ...
                                        <input class="winput winput-md" type="text" name="manual" placeholder="No Manual" required="required" autocomplete="off">
                                    </div>  
                                    <div class="wform-group">
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <button type="submit" class="btn btn-primary" style="font-size: 13px;margin-bottom: 8px">Simpan</button>
                                            </td>
                                        </tr>
                                        </table>
                                    </div> 
