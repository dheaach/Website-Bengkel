...
<body id="page-top">
    ...
    <form method="get" action="">
        ...
        <a href="<?php echo base_url("admin/langsung"); ?>">Reset Filter</a>
    </form>
    <b><?php echo $ket; ?></b><br /><br />
     <a class="btn btn-primary" href="<?php echo base_url() ?>admin/crud/baca/"><i class="fas fa fa-print"></i>  Cetak</a><br /><br />
