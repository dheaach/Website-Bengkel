...
<body id="page-top" style="color:black">
    ...
    <form method="get" action="">
        ...
        <div id="form-tanggal">
            ...
            <input type="text" autocomplete="off" name="tanggal" class="input-tanggal" />
            <br /><br />
        </div>
        ...
        <a class="btn btn-primary" href="<?php echo base_url("semua"); ?>">Reset Filter</a>
    </form>
    <br>
    <form action="<?php echo site_url('semua/search');?>" method = "post">
    ...
    <table style="margin-bottom: 40px;margin-top: 30px">
            <?php 
                ...
                <?php endforeach ?>
    <tr>
        <td>Total : Rp. <?php echo number_format($total,2,",","."); ?></td>
    </tr>
