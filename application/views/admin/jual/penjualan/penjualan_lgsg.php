...
<div class="row">
	<div class="col-md-12">
	<form action="penjualan/simpan_penjualan" method="POST">
 <?php //-------------------------------------------------------------------------------------------------------  ?> 
        ...
        <div class="rows rows-rols">
            <div class="wcol-12 rows-rols wbodytitle-top walign-large">
                <table border="0" class="wform-group">
                    <tr>
                        <td><h6>Halaman / <span>Penjualan Lansung</span></h6></td>
                            ...
                            <div class="rows">
                                ...
                                <div class="wcol-4">
                                    <div class="wform-group">
                                        ...
                                        <input class="winput winput-md" type="text" name="manual" placeholder="No Manual" required="required">
                                    </div>  
                                     <div class="wform-group">
    ...
    <div class="rows rows-rols">
        ...
        <table class="table table-bordered">
            ...
            <?php foreach($this->cart->contents() as $items): ?>
                ...
                <td>
                    <a href="penjualan/hapus_cart/<?php echo $items['rowid'] ?>" class="btn btn-warning btn-sm">X</a>
                </td>
        	</tr>
        	<?php $i++; $no++;?>
            <?php endforeach; ?>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form action="penjualan/simpan_cart" method="POST">
