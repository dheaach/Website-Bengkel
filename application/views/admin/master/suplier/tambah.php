			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php base_url('suplier/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="id">Id Suplier</label>
								<input class="form-control <?php echo form_error('id') ? 'is-invalid':'' ?>"
								 type="text" name="id" placeholder="ID Suplier" autocomplete="off"/>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
								 type="text" name="nama" placeholder="Suplier Name" autocomplete="off"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tlp') ? 'is-invalid':'' ?>"
								 type="text" name="tlp" placeholder="Telepon" autocomplete="off"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('fax') ? 'is-invalid':'' ?>"
								 type="text" name="fax" placeholder="Fax" autocomplete="off"/>
								<div class="invalid-feedback">
